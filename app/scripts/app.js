...
(function (document) {
  ...
  function lazyLoadPolymerAndElements() {
    ...
    // FIXME: Use proper bundles like https://aerotwist.com/blog/polymer-for-the-performance-obsessed/
    var elements = [
    ...
    document.dispatchEvent(
      new CustomEvent('MainUIReady', { bubbles: true })
    );
  }
  ...
  window.addEventListener('MainUIReady', function() {
